...
release: gnublin-installer
	...
	@echo " Gnublin-Installer is a graphical installer for GNUBLIN embedded Linux board." >> deb/DEBIAN/control
	@echo " It can download automatically all needed files from gnublin.org." >> deb/DEBIAN/control
